...
def enable_plugin(app: App) -> None:
        ...
        blocks = [
            {
                ...
                "type": "input",
                "element": {"type": "plain_text_input", "action_id": "choice-action"},
                "label": {"type": "plain_text", "text": "文字列を入力してね", "emoji": True},
            }
        ]
        say(blocks=blocks)
    ...
    def choice_modal(say: Say):
        blocks = [
            {
                "type": "section",
                "text": {"type": "mrkdwn", "text": "ボタンを押すとモーダルが開くよ"},
                "accessory": {
                    "type": "button",
                    "text": {"type": "plain_text", "text": "モーダルを開く", "emoji": True},
                    "value": "clicked",
